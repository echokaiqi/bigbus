...
namespace User\Api;
use User\Api\Api;
use User\Model\HomeMemberModel;



class HomeUserApi extends Api{
    /**
     * 构造方法，实例化操作模型
     */
    protected function _init(){
        $this->model = new HomeMemberModel();
    }
     ...
     * @param  string $identitycardno   用户身份证号
     * @return integer          注册成功-用户信息，注册失败-错误编号
     */
    public function register($username, $password, $email= '' , $mobile='' ,$sex=0,$identitycardno=''){
        return $this->model->register($username, $password, $email, $mobile,$sex,$identitycardno);
    }
