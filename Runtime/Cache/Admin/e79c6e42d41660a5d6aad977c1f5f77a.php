...
<body>
    ...
    <form action="<?php echo U();?>" method="post" class="form-Route-add">
        <div class="form-item">
            <label class="item-label">班车名称<span class="check-tips">（班车名称 5位以内）</span></label>
            <div class="controls">
        ...
        <br />
        <div class="form-item">
            <label class="item-label">班车类型<span class="check-tips">（请核实你的班车）</span></label>
            <div class="controls">
                <select name="pid">
                    <?php if(is_array($rank)): $i = 0; $__LIST__ = $rank;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ra): $mod = ($i % 2 );++$i;?><option value="<?php echo ($ra["id"]); ?>"><?php echo ($ra["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
            </div>
        </div>
        <br />
        <div class="form-item">
            <label class="item-label">线路类型<span class="check-tips">（请核实你的线路）</span></label>
            <div class="controls">
                <select name="rid">
                    <?php if(is_array($route)): $i = 0; $__LIST__ = $route;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ro): $mod = ($i % 2 );++$i;?><option value="<?php echo ($ro["id"]); ?>"><?php echo ($ro["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
            </div>
        </div>
        <br />
        <div class="form-item">
            <label class="item-label">显示<span class="check-tips">（是否显示）</span></label>
            <div class="controls">
                <input type="radio" name="hide" value="0" checked="checked" /> 显示
                &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <script type="text/javascript">
        //导航高亮
        highlight_subnav('<?php echo U('Bus/bus_add');?>');
