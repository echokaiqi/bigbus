...
<body>
    ...
    <?php if(empty($data)): ?><script>
            alert("请按正常渠道进入,您目前的行为已进入日志！");
        </script>
         请按正常渠道进入,您目前的行为已进入日志！
        <?php else: ?>
        用户:<?php echo ($data["nickname"]); ?>


        <form action="<?php echo U();?>" method="post" class="form-horizontal">
            <br />
            <div class="form-item">
                派遣至: <select name="place">
    ...
    <script type="text/javascript">
        //导航高亮
        highlight_subnav('<?php echo U('User/userSend');?>');
    </script>
