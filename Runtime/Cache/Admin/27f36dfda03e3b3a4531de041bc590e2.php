...
<body>
    ...
    <form action="<?php echo U();?>" method="post" class="form-horizontal">
        <div class="form-item">
            <label class="item-label">公司名称<span class="check-tips">（少于16位）</span></label>
            <div class="controls">
                <input type="text" class="text input-large" name="title" value="">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">公司位置<span class="check-tips">（具体到县即可）</span></label>
            <div class="controls">
    ...
    <script type="text/javascript">
        //导航高亮
        highlight_subnav('<?php echo U('User/placeAdd');?>');
    </script>
