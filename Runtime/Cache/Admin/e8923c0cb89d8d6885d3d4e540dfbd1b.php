...
<body>
    ...
    <form action="<?php echo U();?>" method="post" class="form-Route-add">
        <div class="form-item">
            <label class="item-label">班车类型名称<span class="check-tips">（类型名称 5位以内）</span></label>
            <div class="controls">
                <input type="text" class="text input-large" name="title" value="<?php echo ($data["title"]); ?>">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">乘坐人数<span class="check-tips">（乘坐人数不得超过100人）</span></label>
            <div class="controls">
                <input type="text" class="text input-large" name="number" value="<?php echo ($data["number"]); ?>">
            </div>
        </div>
        <div class="form-item">
    ...
    <script type="text/javascript">
        //导航高亮
        highlight_subnav('<?php echo U('Bus/add');?>');
