...
<body>
	...
	<div class="cf">
		<div class="fl">
            <a class="btn" href="<?php echo U('placeAdd');?>">新 增</a>
        </div>
    ...
    <tbody>
		<?php if(!empty($data)): if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
			...
			<td><a href="<?php echo U('Route/showList?id='.$vo['id']);?>"><?php echo ($vo["title"]); ?></a></td>
		...
		<?php else: ?>
		<td colspan="9" class="text-center"> Oh! 暂时还没有录入公司! </td><?php endif; ?>
	</tbody>
    </table>
	</div>
    <div class="pages">
