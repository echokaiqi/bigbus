...
<body>
	...
	<div class="cf">
		<div class="fl">
            <a class="btn" href="<?php echo U('bus_add');?>">新 增</a>
        </div>
    ...
    <tbody>
		<?php if(!empty($data)): if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
			...
			<?php if($vo["pstatus"] == 0 ): ?><td style="color:green;"><?php echo ($vo["ptitle"]); ?></td>
				<?php elseif($vo["pstatus"] == 1 ): ?>
				<td style="color:darkred;"><?php echo ($vo["ptitle"]); ?></td>
				<?php else: ?>
				<!--end ..--><?php endif; ?>

			<?php if($vo["tstatus"] == 0 ): ?><td style="color:green;"><?php echo ($vo["ttitle"]); ?></td>
				<?php elseif($vo["tstatus"] == 1 ): ?>
				<td style="color:blue;"><?php echo ($vo["ttitle"]); ?></td>
				<?php else: ?>
				<td style="color:darkred;"><?php echo ($vo["ttitle"]); ?></td><?php endif; ?>

			<td>
				<a href="<?php echo U('Bus/busUpCode?id='.$vo['id']);?>">上车</a>
				<a href="<?php echo U('Bus/busDoCode?id='.$vo['id']);?>">下车</a>
			</td>
			...
			<td>
				<a href="<?php echo U('Bus/upd?id='.$vo['id']);?>">调度</a>
				<a href="<?php echo U('Driver/detail?did='.$vo['id']);?>">司机</a>
				<a href="<?php echo U('User/behavior?pid='.$vo['id']);?>">会员</a>
            </td>
    ...
    //导航高亮
    highlight_subnav('<?php echo U('Bus/detail');?>');
	</script>
