...
<body>
    ...
    <form action="<?php echo U();?>" method="post" class="form-Route-add">
        <div class="form-item">
            <label class="item-label">线路名称<span class="check-tips">（线路命名区分 12位以内）</span></label>
            <div class="controls">
                <input type="text" class="text input-large" name="title" value="<?php echo ($data["title"]); ?>">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">起始<span class="check-tips">（录入线路的出发点 12位以内）</span></label>
            <div class="controls">
                <input type="text" class="text input-large" name="start" value="<?php echo ($data["start"]); ?>">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">结束<span class="check-tips">（录入线路的终点站 12位以内）</span></label>
            <div class="controls">
                <input type="text" class="text input-large" name="end" value="<?php echo ($data["end"]); ?>">
            </div>
        </div>
        <br />
        <div class="form-item">
    ...
    <script type="text/javascript">
        //导航高亮
        highlight_subnav('<?php echo U('Route/add');?>');
